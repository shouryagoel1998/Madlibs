...
legs off, {number} seconds to take in the ring of attributes all equidistant from the {sound_important},a giant \
{adj} {noun2} shaped like a {noun3} with a curved bell tail, the mouthof which is at least twenty feet \
high, spilling over with the things that will give us life here in the arena. Food, containers of water, \
{noun_plural_2} , medicine, garmentsm {noun_plural_3}. Strewn around the {sound_important} are other supplies, their value \
decreasing the father they are from the {noun2}. For instance, only a few steps from my feet  lies a three-foot \
square of {noun4}. Certainly it could be of some use in a downpour. But there in the mouth, I can see a {noun5} \
that would protect form almost any sort of weather. If I had the guts to go in and {verb2} for it against \
